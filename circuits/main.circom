...
template RSAGroupSigVerify(n, k, levels) {
    ...
    signal input enableNullifier;
    enableNullifier * (enableNullifier - 1) === 0;
    ...
    nullifierOpeningPoseidon.inputs[1] <== nullifierKey;
    ...
    nullifier <== nullifierPoseidon.out * enableNullifier;
    log(nullifier);
    ...
    all_public_hasher.inputs[1] <== nullifier;
    all_public_hasher.inputs[2] <== nullifierKey;
    all_public_hasher.inputs[3] <== payload;
    all_public_hasher.inputs[4] <== root;
    all_public_hasher.inputs[5] <== enableNullifier;
