...
template RSAGroupSigVerify(n, k, levels) {
    ...
    signal input modulus[k];
    signal input base_message[k];
    signal input payload1;
    signal input payload2;
    signal payload2Squared;
    payload2Squared <== payload2 * payload2;
    ...
    nullifierOpeningPoseidon.inputs[1] <== payload1;
