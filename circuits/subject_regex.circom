...
template WalletSubjectRegex (msg_bytes) {
    ...
    component eq[125][num_bytes];
    component lt[58][num_bytes];
    component and[106][num_bytes];
    component multi_or[21][num_bytes];
    signal states[num_bytes+1][54];
    ...
    for (var i = 0; i < num_bytes; i++) {
        ...
        eq[96][i].in[1] <== 64;
        and[61][i] = AND();
        and[61][i].a <== states[i][37];
        and[61][i].b <== eq[96][i].out;
        multi_or[10][i] = MultiOR(4);
        multi_or[10][i].in[0] <== and[58][i].out;
        multi_or[10][i].in[1] <== and[59][i].out;
        multi_or[10][i].in[2] <== and[60][i].out;
        multi_or[10][i].in[3] <== and[61][i].out;
        states[i+1][31] <== multi_or[10][i].out;
        eq[97][i] = IsEqual();
        eq[97][i].in[0] <== in[i];
        eq[97][i].in[1] <== 117;
        and[62][i] = AND();
        and[62][i].a <== states[i][29];
        ...
        and[86][i].b <== eq[112][i].out;
        eq[113][i] = IsEqual();
        eq[113][i].in[0] <== in[i];
        eq[113][i].in[1] <== 92;
        and[87][i] = AND();
        and[87][i].a <== states[i][43];
        and[87][i].b <== eq[113][i].out;
        multi_or[16][i] = MultiOR(2);
        multi_or[16][i].in[0] <== and[86][i].out;
        multi_or[16][i].in[1] <== and[87][i].out;
        states[i+1][42] <== multi_or[16][i].out;
        lt[46][i] = LessThan(8);
        lt[46][i].in[0] <== 64;
        lt[46][i].in[1] <== in[i];
        lt[47][i] = LessThan(8);
        ...
        multi_or[17][i].in[0] <== and[88][i].out;
        multi_or[17][i].in[1] <== and[89][i].out;
        multi_or[17][i].in[2] <== and[90][i].out;
        ...
        multi_or[18][i].in[0] <== and[92][i].out;
        multi_or[18][i].in[1] <== and[93][i].out;
        multi_or[18][i].in[2] <== and[94][i].out;
        and[95][i].b <== multi_or[18][i].out;
        multi_or[19][i] = MultiOR(2);
        multi_or[19][i].in[0] <== and[91][i].out;
        multi_or[19][i].in[1] <== and[95][i].out;
        states[i+1][43] <== multi_or[19][i].out;
        eq[114][i] = IsEqual();
        eq[114][i].in[0] <== in[i];
        eq[114][i].in[1] <== 58;
        and[96][i] = AND();
        and[96][i].a <== states[i][41];
        and[96][i].b <== eq[114][i].out;
        ...
        multi_or[20][i].in[0] <== eq[115][i].out;
        multi_or[20][i].in[1] <== eq[116][i].out;
        and[97][i].b <== multi_or[20][i].out;
        ...
        eq[121][i].in[1] <== 110;
        and[102][i] = AND();
        and[102][i].a <== states[i][49];
        and[102][i].b <== eq[121][i].out;
        states[i+1][50] <== and[102][i].out;
        eq[122][i] = IsEqual();
        eq[122][i].in[0] <== in[i];
        eq[122][i].in[1] <== 100;
        and[103][i] = AND();
        and[103][i].a <== states[i][48];
        and[103][i].b <== eq[122][i].out;
        states[i+1][51] <== and[103][i].out;
        eq[123][i] = IsEqual();
        eq[123][i].in[0] <== in[i];
        eq[123][i].in[1] <== 32;
        and[104][i] = AND();
        and[104][i].a <== states[i][51];
        and[104][i].b <== eq[123][i].out;
        states[i+1][52] <== and[104][i].out;
        eq[124][i] = IsEqual();
        eq[124][i].in[0] <== in[i];
        eq[124][i].in[1] <== 36;
        and[105][i] = AND();
        and[105][i].a <== states[i][52];
        and[105][i].b <== eq[124][i].out;
        states[i+1][53] <== and[105][i].out;
    }

    signal final_state_sum[num_bytes+1];
    final_state_sum[0] <== states[0][50];
    for (var i = 1; i <= num_bytes; i++) {
        final_state_sum[i] <== final_state_sum[i-1] + states[i][50];
    }
    ...
    for (var i = 0; i < msg_bytes; i++) {
        reveal_recipient[i] <== in[i+1] * (states[i+2][27] + states[i+2][33] + states[i+2][37] + states[i+2][38] + states[i+2][25] + states[i+2][31] + states[i+2][34] + states[i+2][39] + states[i+2][43]);
    }
}
