...
| 4   | Deployment             | DKIM Registry deployment to Paseo testnet                                                                                             | A functioning DKIM Registry deployed to Paseo testnet                                                               | `DKIMRegistry` deployed and live on Paseo Assethub (chain `420420417`) at `0x83A1b3958D49195D3F62C44B42e7a41336Bc3ffc` — viewable on [Blockscout](https://blockscout-testnet.polkadot.io/address/0x83A1b3958D49195D3F62C44B42e7a41336Bc3ffc). **Proof:** [`03_deployment_evidence.md`](./03_deployment_evidence.md).                                                                                 |
