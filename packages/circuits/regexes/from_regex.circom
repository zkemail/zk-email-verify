...
template FromRegex (msg_bytes) {
    ...
    for (var i = 0; i < num_bytes; i++) {
        ...
        lt[25][i].in[1] <== 91;
        and[26][i] = AND();
        and[26][i].a <== lt[24][i].out;
        and[26][i].b <== lt[25][i].out;
        lt[26][i] = LessThan(8);
        lt[26][i].in[0] <== 96;
        lt[26][i].in[1] <== in[i];
        lt[27][i] = LessThan(8);
        ...
        lt[27][i].in[1] <== 123;
        and[27][i] = AND();
        and[27][i].a <== lt[26][i].out;
        and[27][i].b <== lt[27][i].out;
        lt[28][i] = LessThan(8);
        lt[28][i].in[0] <== 47;
        lt[28][i].in[1] <== in[i];
        lt[29][i] = LessThan(8);
        ...
        lt[29][i].in[1] <== 58;
        and[28][i] = AND();
        and[28][i].a <== lt[28][i].out;
        and[28][i].b <== lt[29][i].out;
        eq[30][i] = IsEqual();
        eq[30][i].in[0] <== in[i];
        eq[30][i].in[1] <== 45;
        eq[31][i] = IsEqual();
        ...
        multi_or[7][i].in[2] <== and[28][i].out;
        multi_or[7][i].in[3] <== eq[30][i].out;
        multi_or[7][i].in[4] <== eq[31][i].out;
        multi_or[7][i].in[5] <== eq[32][i].out;
        ...
        lt[31][i].in[1] <== 91;
        and[30][i] = AND();
        and[30][i].a <== lt[30][i].out;
        and[30][i].b <== lt[31][i].out;
        lt[32][i] = LessThan(8);
        lt[32][i].in[0] <== 96;
        lt[32][i].in[1] <== in[i];
        lt[33][i] = LessThan(8);
        ...
        lt[33][i].in[1] <== 123;
        and[31][i] = AND();
        and[31][i].a <== lt[32][i].out;
        and[31][i].b <== lt[33][i].out;
        lt[34][i] = LessThan(8);
        lt[34][i].in[0] <== 47;
        lt[34][i].in[1] <== in[i];
        lt[35][i] = LessThan(8);
        ...
        lt[35][i].in[1] <== 58;
        and[32][i] = AND();
        and[32][i].a <== lt[34][i].out;
        and[32][i].b <== lt[35][i].out;
        eq[33][i] = IsEqual();
        eq[33][i].in[0] <== in[i];
        eq[33][i].in[1] <== 45;
        eq[34][i] = IsEqual();
        ...
        multi_or[8][i].in[2] <== and[32][i].out;
