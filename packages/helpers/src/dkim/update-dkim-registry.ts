...
async function getSelectors(filename: string) {
  const fs = require('fs');
  const selectors = ['google', 'default', 'mail', 'smtpapi', 'dkim', 'v1', 'v2', 'v3', 'k1', 'k2', 'k3', 'hs1', 'hs2', 's1', 's2', 's3', '200608', 'sig1', 'sig2', 'sig3', 'selector', 'selector1', 'selector2', '20230601', '20221208', 'mindbox', 'bk', 'sm1', 'sm2', 'gmail'];
