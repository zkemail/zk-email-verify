...
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({ 
               x: uint256(0x144d38c5086438ddfe3b753aa6a47c6d28722fd8f3b96c5bcaa2df4928f47636),
               y: uint256(0x240bc37b8bafe680b505b3f1f368d4780884de44f89d2d8a8f3d381c1955d58d)
            }),
            qr: Honk.G1Point({ 
               x: uint256(0x07bfc7d9eda4ce770236f80ef2df1a924a6708e2242a698ffc4311bdaf94b13f),
               y: uint256(0x2101af4ba93a6dc6434c389d4f12007112c187807d710bb65b410d2aee6d23ca)
            }),
            qo: Honk.G1Point({ 
               x: uint256(0x27de4d804916ddeb50ea379fc0a9ab4d4edf25193b4945c5283345f4e925910e),
               y: uint256(0x16569ea9192d0527cd69a59d2348d57823f305cf52ac76fc162e4f72e51526ba)
            }),
            q4: Honk.G1Point({ 
               x: uint256(0x25a920d9734528fcc83e1dc4490838e8d3c26917472418f64d76ff7606c4fcd3),
               y: uint256(0x13f92574cf4c332e71750e07a773fa7979ee15ae18cead655af9ca1e61bbeba1)
            }),
            qm: Honk.G1Point({ 
               x: uint256(0x11964cb967517df8f9740eb0491ffcf8410588665a90f361844a7f93a462a3a9),
               y: uint256(0x1b2194faf2de56d39133d8a0123bf5d7074a076774c7732eba07682ede04a7b0)
            }),
            qc: Honk.G1Point({ 
               x: uint256(0x10c2d1b3c1582f9499417f59c3c03ed7e5f834598768fc667fa8d5eb84ee2338),
               y: uint256(0x0728d79370738aaca553d9a439c04722dca0bc556d92e1b7c78c54228a8c92d5)
            }),
            qArith: Honk.G1Point({ 
               x: uint256(0x1c4dbaec8d2c33faaa35a50f09034234bccc9ca5c509794bc112d356a665be35),
               y: uint256(0x1f9bdd4a1e3c9d6972ac334772faf22ea8cb23a5a90a7313506bbddd7264575c)
            }),
            qDeltaRange: Honk.G1Point({ 
               x: uint256(0x1936a839b1eb141d525f93c21e490fe37c9f838eae81a362a3e58d2570db4632),
               y: uint256(0x04652044dddd6bbebecc4f57f6be3dab7bb2f40d7848d5fdebceeaa9bbe7d587)
            }),
            qElliptic: Honk.G1Point({ 
               x: uint256(0x2e593b256a6d65fd757a9f5d1d7f9e481dc09702e7d8df9bbba262c66b2321d9),
               y: uint256(0x24a37e4fb55dbadc611967105a1235729e9b37392d44bf7d2389f69fadbf862f)
            }),
            qAux: Honk.G1Point({ 
               x: uint256(0x2c0fd1945b7a7c232308067ad565f54b0d17286c03c3092adb5276f9ed050eb0),
               y: uint256(0x0902ecbc4f8f59037229840c6c4f39b736401208334a757aa915df8bd664c44f)
            }),
            qLookup: Honk.G1Point({ 
               x: uint256(0x1126b5b64d5d3da3de808d676aed2509fc72f2dc81681fb4a37e3cb49a8d364c),
               y: uint256(0x2a4f7b041dfcb34b8ca659c61c537675e127ac9f2bcc6820e562d1f4cb19dff8)
            }),
            qPoseidon2External: Honk.G1Point({ 
               x: uint256(0x28b5876d27d41aad105228302312a80e438882074804f4ece89d7baf9788b27d),
               y: uint256(0x268985da2e1b648899cc0eca30ff6e28e6780ede2e7fe3eb08b296da488f6e64)
            }),
            qPoseidon2Internal: Honk.G1Point({ 
               x: uint256(0x1bddffbceb16122e296c81db61aec4070be0d25891b366ffaaa506a83cea16f6),
               y: uint256(0x1e4d7e4e7d9898468ef65d22cd5c17187e9c1146d68f6f4fa4cb4e3c5367742b)
            }),
            s1: Honk.G1Point({ 
               x: uint256(0x12ba734b4d76369b9b5a89741f1e3c7d7a2132985446fdc5e347b08bda5c231a),
               y: uint256(0x044efc32e586f180f517d0b0c89a2a67ca8ac548ea96ec17c95fe21e74fc94e9)
            }),
            s2: Honk.G1Point({ 
               x: uint256(0x22c8abf4a25274aaf0a8356d7829ec60ce8d486348ee44051a4328d6aa47c65b),
               y: uint256(0x12e387b22fdc5ffb409af5ab39e746df68d057a4d157f05683075a4349c3ece2)
            }),
            s3: Honk.G1Point({ 
               x: uint256(0x0609ba5678940da31acbecb4d8bbf21e48f4a0defc1bfbf710928d781adcec35),
               y: uint256(0x21bd9b052f61b868893e376b5b808588154d0352b77bfef1ba6d0481694f7e72)
            }),
            s4: Honk.G1Point({ 
               x: uint256(0x0b11ded697eb780684b9fcc0dfdde8eb45762feec291ec1085df74cfdb06165e),
               y: uint256(0x20d1fd7b0b8717ae0af1d181a3e5e5a4bac5e8d918f7992248c0d03b9033ca44)
            }),
            t1: Honk.G1Point({ 
            ...
            id1: Honk.G1Point({ 
               x: uint256(0x10c89918952878d00bebb60aa9dd07ab3014bbac08983049ec7296b4f77e9e71),
               y: uint256(0x0cbab4ca809b9e6071e8f0c93e7c82fa28702ec107350d26fd7b0407c254ce7a)
            }),
            id2: Honk.G1Point({ 
               x: uint256(0x13cdc400fdfb8f7d14b968df4564c20cb17bcdfded68433465e1e9bcf9176805),
               y: uint256(0x07fa06e015f64e43ba68b4282528faaf07e39ba6bd9717b8ee5a811601091905)
            }),
            id3: Honk.G1Point({ 
               x: uint256(0x1a8478663d73059509ed315f70316cde885b8a3a3ddafc947c4f9843115392dc),
               y: uint256(0x1c6735c49c8379fa699e0b147c01ba6b79e27a278e80172512c676afd3db95b8)
            }),
            id4: Honk.G1Point({ 
               x: uint256(0x2ed344002c5b40ed628fe0cacd3377f50cdb99f61b356ab4ab4f398bcff2b464),
               y: uint256(0x07983c52d5aec9c8e1b72973c6864236b96c20f1dc8a4556b895953ad9ad2e33)
            }),
            ...
            lagrangeLast: Honk.G1Point({ 
               x: uint256(0x0369104a6649f14b09974438a02d68741a247d3d092d6fdb132a56845c26fe4b),
               y: uint256(0x1dc3753d0e6a6ad517789d4aae156eba12308bc26410b2ff3caefd27e68a636e)
            })
        });
        return vk;
    }
...
contract HonkVerifierSCALE7 is BaseHonkVerifier(N, LOG_N, NUMBER_OF_PUBLIC_INPUTS) {
