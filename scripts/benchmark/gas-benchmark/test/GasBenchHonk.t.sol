...
import {HonkVerifierSCALE2} from "../src/verifiers/HonkVerifierSCALE2.sol";
import {HonkVerifierSCALE3} from "../src/verifiers/HonkVerifierSCALE3.sol";
import {HonkVerifierSCALE4} from "../src/verifiers/HonkVerifierSCALE4.sol";
import {HonkVerifierSCALE5} from "../src/verifiers/HonkVerifierSCALE5.sol";
import {HonkVerifierSCALE6} from "../src/verifiers/HonkVerifierSCALE6.sol";
...
contract GasBenchHonk is Test {
    ...
    function testHonk_SCALE2() public { _measure("SCALE-2", IHonk(address(new HonkVerifierSCALE2()))); }
    function testHonk_SCALE3() public { _measure("SCALE-3", IHonk(address(new HonkVerifierSCALE3()))); }
    function testHonk_SCALE4() public { _measure("SCALE-4", IHonk(address(new HonkVerifierSCALE4()))); }
    function testHonk_SCALE5() public { _measure("SCALE-5", IHonk(address(new HonkVerifierSCALE5()))); }
    function testHonk_SCALE6() public { _measure("SCALE-6", IHonk(address(new HonkVerifierSCALE6()))); }
