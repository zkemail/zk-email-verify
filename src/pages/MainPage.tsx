...
// import email_wasm from "../circuits/email.wasm";
// import email_zkey from "../circuits/email.zkey";
import vkey_json from "../circuits/email_verification_key.json";
import proof_json from "../circuits/proof.json";
import public_json from "../circuits/public.json";
      ...
      <Main>
        <Column>
          ...
          <Button
            ...
            disabled={
              displayMessage !== "Prove" || emailFull.length === 0
            ...
            onClick={async () => {
              ...
              // console.log("public ja: ", publicSignals);
