...
import { generate_inputs } from "../scripts/generate_input";
...
export const MainPage: React.FC<{}> = (props) => {
  ...
  const { value, error } = useAsync(async () => {
    try {
      const circuitInputs =
        await generate_inputs(emailFull, ethereumAddress);
        ...
        <div className="buttonsPane">
          <button
            ...
            onClick={async () => {
              ...
              const input = await generate_input.generate_inputs(atob(mail));
